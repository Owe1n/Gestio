...
public class AddMaterielController extends MainController {
	...
	public void handleClickValider(ActionEvent e) {
		...
		if (matModel.getMaterielById(Integer.parseInt(textFieldId.getText())).getName() != null) {
			...
			Materiel materiel = new Materiel(Integer.parseInt(textFieldId.getText()), textFieldName.getText(),
					textFieldMaterielImgPath.getText(), Integer.parseInt(textFieldBon.getText()),
					Integer.parseInt(textFieldMoyen.getText()), Integer.parseInt(textFieldMauvais.getText()));
	...
	public AnchorPane build() {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/vues/AddMateriel.fxml"));
